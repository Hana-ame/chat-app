...
(function () {
  ...
  css.textContent = [
    ...
    ".cw-msgs{flex:1;overflow-y:scroll;min-height:0;padding:12px;display:flex;flex-direction:column;gap:6px;scrollbar-width:thin;scrollbar-color:#e94560 transparent}",
    ...
    ".cw-msgs::-webkit-scrollbar-thumb{background:#e94560;border-radius:12px}",
    ".cw-msgs::-webkit-scrollbar-thumb:hover{background:#ff6b81}",
  ].join("\n");
